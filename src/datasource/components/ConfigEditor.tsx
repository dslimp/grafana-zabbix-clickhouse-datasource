...
const SUPPORTED_SQL_DS = ['mysql', 'grafana-postgresql-datasource', 'postgres', 'influxdb', 'grafana-clickhouse-datasource'];
  ...
  return (
    <>
      <DataSourceDescription
        ...
        docsLink="https://grafana.com/docs/plugins/dslimp-zabbix-clickhouse-app/latest/configuration/"
            ...
            <>
              <Field label="Data Source">
                <Combobox
                  ...
                  placeholder="Select a DB datasource (MySQL, PostgreSQL, ClickHouse, InfluxDB)"
                />
              </Field>
