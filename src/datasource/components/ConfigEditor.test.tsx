  ...
  describe('Direct DB datasource selection', () => {
    beforeEach(() => {
      mockGetList.mockReturnValue([
        { id: 3, uid: 'clickhouse-uid', name: 'ClickHouse Zabbix', type: 'grafana-clickhouse-datasource' },
    ...
    it('shows ClickHouse datasource among supported direct DB options', () => {
      const options = getDefaultOptions();
      options.jsonData = {
        ...options.jsonData,
        dbConnectionEnable: true,
      ...
      expect(screen.getByRole('button', { name: 'ClickHouse Zabbix' })).toBeInTheDocument();
    });
  });
});
